      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-primary-700 mb-4">Contemporary Fine Artist | b. June 1, 1986, Krichim, Bulgaria</p>
            
            <div className="prose prose-primary max-w-none">
              <p className="mb-4">
                Radka Gicheva is a contemporary artist whose work explores the intersection of traditional techniques and modern expression. Born and raised in Krichim, Bulgaria, she developed a passion for art at an early age, inspired by the rich cultural heritage of Eastern Europe and the dramatic landscapes of her homeland.
              </p>
              <p className="mb-4">
        ...
        <div className="mb-12">
          ...
          <div className="prose prose-primary max-w-none">
            <p className="mb-4">
              Radka's artistic journey began with classical training in oils and watercolors, but she quickly developed an interest in experimental techniques and mixed media. Her early works were heavily influenced by the Eastern European expressionist tradition, featuring emotional landscapes and symbolic imagery.
            </p>
            <p className="mb-4">
              In 2010, Radka relocated to Western Europe, where she established her studio and began exhibiting her work internationally. This period marked a significant evolution in her style, as she incorporated more abstract elements and began exploring themes of memory, identity, and the relationship between humans and their environment.
            </p>
            <p className="mb-4">
              Today, Radka's paintings can be found in private collections across Europe and North America. Her recent work has focused on large-scale canvases that invite viewers to immerse themselves in richly textured worlds of color and form, blurring the boundaries between the real and the imagined.
            </p>
          </div>
        </div>
